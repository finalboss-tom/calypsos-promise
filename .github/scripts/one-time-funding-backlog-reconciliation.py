...
sprints = "docs/roadmap/sprints.md"
...
completion = "docs/economics/phase-0-funding-completion-record.md"
replace(
    completion,
...
""",
    """| Capture, data, provider, exclusivity, related-party, concentration, source-loss, and outcome-failure scenarios are exercised                                                    | Sixteen design tabletops                              | Met at founding-steward design-tabletop level |
| The public website cannot activate donation or sponsorship transactions before a legitimate recipient, custody, accounting, tax, privacy, refund, and payment route is accepted | Decision 0008; operating baseline; website handoff    | Met at doctrine and roadmap level             |
| No legal, charitable, tax, treasury, accounting, or operating financial status is overstated                                                                                    | All status and non-scope records                      | Met                                           |
""",
)

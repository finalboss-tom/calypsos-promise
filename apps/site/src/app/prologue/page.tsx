  ...
  return (
    <article className="promise-page">
      <header className="promise-page-header">
        ...
        <p className="summary">
          This branch-only experience demonstrates arrival and Lantern Shore without
          an account, health-data intake, microphone, model provider, analytics, or
          durable state. Refreshing or leaving starts the demonstration again.
        </p>
        <p className="source-note">
          Workstream 9.2 is under review. The route is noindex, absent from public
          navigation and the sitemap, and is not deployed through this pull request.
        </p>

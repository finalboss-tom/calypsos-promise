...
5. [Pre-Sprint 7 Alignment Review](pre-sprint-7-alignment-review.md)
6. [Sprint 6 Completion Record](sprint-6-completion-record.md)
7. [Sprint 6 Cross-Contract Reconciliation](../architecture/aster-sprint-6-cross-contract-reconciliation.md)
8. [Sprint 6 Control and Evidence Map](../architecture/aster-sprint-6-control-and-evidence-map.md)
9. [Sprint 6 Specialist Holdpoints and Unresolved Work](../architecture/aster-sprint-6-specialist-holdpoint-and-unresolved-work-register.md)
10. [Sprint Sequence](sprints.md)
11. [Pre-Sprint 6 Alignment Review](pre-sprint-6-alignment-review.md)
...
13. [Operational Simplicity and Durable Workflows Workstream](operational-simplicity-workstream.md)
14. [Mission-to-Runtime Traceability](../architecture/mission-to-runtime-traceability.md)
...
16. [Consumer-First and Institutional Interoperability Workstream](consumer-first-provider-independent-workstream.md)
17. [Phase 0 Funding and Sponsorship Baseline](../economics/README.md)
18. [Proposed Health Data Legacy Workstream](health-data-legacy-workstream.md)
19. [Sprint 5 Completion Record](sprint-5-completion-record.md)

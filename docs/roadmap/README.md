...
[Documentation home](../README.md) · [Institutional roadmap](../../ROADMAP.md) · [Current status](current-status.md) · [Funding baseline](../economics/README.md) · [Consumer-first workstream](consumer-first-provider-independent-workstream.md) · [Sprint 5 completion](sprint-5-completion-record.md) · [Sprint sequence](sprints.md)
...
Advancement is gate-based rather than calendar-based. A completed design sprint or institutional doctrine does not imply that a production capability, financial system, provider integration, institutional phase, or public claim is live.
...
4. [Proposed Consumer-First and Institutional Interoperability Workstream](consumer-first-provider-independent-workstream.md)
5. [Decision 0010 — Consumer-First, Provider-Independent Product Boundary](../decisions/0010-consumer-first-provider-independent-boundary.md)
6. [Consumer-First and Provider-Independent Architecture](../architecture/consumer-first-provider-independent-boundary.md)
7. [AS-0012 — Consumer-First Continuity Can Create Durable Personal Value](../governance/assumption-AS-0012-consumer-first-continuity-value.md)
8. [Proposed Health Data Legacy Workstream](health-data-legacy-workstream.md)
9. [Decision 0009 — Health Data Legacy and Post-Mortem Stewardship](../decisions/0009-health-data-legacy-and-post-mortem-stewardship.md)
10. [Health Data Legacy and Succession Architecture](../architecture/health-data-legacy-and-succession.md)
11. [Sprint 5 Completion Record](sprint-5-completion-record.md)
12. [Security Architecture](../security/README.md)
13. [Sprint Sequence](sprints.md)
14. [Public Institutional Roadmap](../../ROADMAP.md)
15. [Sprint 5 Plan](sprint-5-plan.md)
16. [Pre-Sprint 5 Alignment Review](pre-sprint-5-alignment-review.md)
17. [Sprint 4 Completion Record](sprint-4-completion-record.md)
...
- [Proposed Consumer-First and Institutional Interoperability Workstream](consumer-first-provider-independent-workstream.md) — cross-phase doctrine and future partnership gates tracked by issue #41; does not change Sprint 6 order or authorize a provider runtime
...
Issue #41 and the proposed consumer-first documentation define a provider-independent product center, standards-at-the-edges architecture, Sprint 14 connector inheritance, funding and sponsorship conflicts, and later clinical and enterprise partnership gates. They do not select a standard, activate a connector, prohibit future institutional collaboration, authorize clinical use, or represent the consumer-first thesis as validated.

Sprint 6 — Aster contracts and AI governance is the next numbered design-to-build boundary. Sprint 6 inherits the merged Sprint 5 security constraints, Decision 0008’s provider-neutrality and funding-conflict boundaries, and—if accepted—Decision 0010’s source-attribution and non-canonical provider boundary.
...
The remaining institutional Phase 0 work includes key-person dependency, succession and emergency ownership, founder-reserved powers, historical governance-source recovery, branch-protection evidence, commit-level DCO transition, the factual founder-subsidy and economic-dependency register, explicit disposition of proposed Decisions 0009 and 0010, and the explicit Phase 0 exit review.

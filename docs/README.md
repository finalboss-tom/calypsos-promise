...
[Repository home](../README.md) · [Vision](../VISION.md) · [Roadmap](../ROADMAP.md) · [Governance](../GOVERNANCE.md) · [Contributing](../CONTRIBUTING.md) · [Current status](roadmap/current-status.md) · [Sprint 5 plan](roadmap/sprint-5-plan.md)
...
2. [Sprint 5 Plan](roadmap/sprint-5-plan.md)
...
1. [Sprint 5 Plan](roadmap/sprint-5-plan.md)
2. [Security Architecture](security/README.md)
3. [Control Status and Risk Vocabulary](security/control-status-and-risk-vocabulary.md)
...
- [`security`](security/README.md) — Sprint 5 security architecture, control-status vocabulary, and future threat-model artifacts
